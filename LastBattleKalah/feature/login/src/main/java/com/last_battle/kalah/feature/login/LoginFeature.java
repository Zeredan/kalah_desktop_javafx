package com.last_battle.kalah.feature.login;
...
public class LoginFeature implements BaseFeature {
    ...
    private VBox createContentArea() {
        ...
        formContainer.getChildren().addAll(usernameField, passwordField, errorLabel);
        ...
        loginButton.setOnAction(e -> {
            ...
            profileVM.logIn(username, password);
        });
